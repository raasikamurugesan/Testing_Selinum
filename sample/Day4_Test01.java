...
public class Day4_Test01 
{
	...
	driver.findElement(By.xpath("//*[@id=\"input-firstname\"]")).sendKeys("raasika");
	driver.findElement(By.xpath("//*[@id=\"input-lastname\"]")).sendKeys("Murugesan");
	driver.findElement(By.xpath("//*[@id=\"input-email\"]")).sendKeys("raasikamurugesan@gmail.com");
	driver.findElement(By.xpath("//*[@id=\"input-password\"]")).sendKeys("raasika");
